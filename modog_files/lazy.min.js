...
k?((1<f.length||1==f.length&&""!=f[0])&&f.pop(),d&&g==e.length&&f.push("")):(f.push(k),d=!0)}d=f.join("/")}else d=e}c?(T(b),b.o=d):c=""!==a.g.toString();c?Ab(b,a.g.clone()):c=!!a.K;c&&(a=a.K,T(b),b.K=a);return b};S.prototype.clone=function(){return new S(this)};
var yb=function(a,b,c){T(a);a.A=c?U(b,!0):b;a.A&&(a.A=a.A.replace(/:$/,""))},zb=function(a,b){T(a);if(b){b=Number(b);if(isNaN(b)||0>b)throw Error("Bad port number "+b);a.R=b}else a.R=null},Ab=function(a,b,c){T(a);b instanceof V?(a.g=b,a.g.ta(a.i)):(c||(b=W(b,Fb)),a.g=new V(b,a.i))};S.prototype.getQuery=function(){return this.g.toString()};S.prototype.removeParameter=function(a){T(this);this.g.remove(a);return this};var T=function(a){if(a.Na)throw Error("Tried to modify a read-only Uri");};
S.prototype.ta=function(a){this.i=a;this.g&&this.g.ta(a)};
var U=function(a,b){return a?b?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""},W=function(a,b,c){return m(a)?(a=encodeURI(a).replace(b,Gb),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null},Gb=function(a){a=a.charCodeAt(0);return"%"+(a>>4&15).toString(16)+(a&15).toString(16)},Bb=/[#\/\?@]/g,Db=/[#\?:]/g,Cb=/[#\?]/g,Fb=/[#\?@]/g,Eb=/#/g,V=function(a,b){this.b=this.a=null;this.h=a||null;this.i=!!b},X=function(a){a.a||(a.a=new Q,a.b=0,a.h&&xb(a.h,function(b,c){a.add(decodeURIComponent(b.replace(/\+/g,
...
h.u=function(){X(this);for(var a=this.a.j(),b=this.a.u(),c=[],d=0;d<b.length;d++)for(var e=a[d],f=0;f<e.length;f++)c.push(b[d]);return c};h.j=function(a){X(this);var b=[];if(m(a))this.G(a)&&(b=la(b,this.a.get(Y(this,a))));else{a=this.a.j();for(var c=0;c<a.length;c++)b=la(b,a[c])}return b};h.set=function(a,b){X(this);this.h=null;a=Y(this,a);this.G(a)&&(this.b-=this.a.get(a).length);this.a.set(a,[b]);this.b+=1;return this};
...
var Y=function(a,b){var c=String(b);a.i&&(c=c.toLowerCase());return c};V.prototype.ta=function(a){a&&!this.i&&(X(this),this.h=null,this.a.forEach(function(a,c){var b=c.toLowerCase();c!=b&&(this.remove(c),this.remove(b),0<a.length&&(this.h=null,this.a.set(Y(this,b),ma(a)),this.b+=a.length))},this));this.i=a};V.prototype.extend=function(a){for(var b=0;b<arguments.length;b++)vb(arguments[b],function(a,b){this.add(b,a)},this)};var Hb=function(){this.H=("undefined"==typeof document?null:document)||{cookie:""}};h=Hb.prototype;h.isEnabled=function(){return navigator.cookieEnabled};
...
window.top.location);b=a.J?Ob(a.J,{D:n,document:g,I:k,O:b,locale:c,source:a.source,B:a.B,S:d}):Va();K(b);return!0},Pb=function(a){a=a instanceof S?a.clone():new S(a,void 0);var b=a.g.get("ghstartsource")||"";return{J:parseInt(a.g.get("ghstartflowid"),10)||0,B:a.g.get("ghstartstepid")||"",source:{helpcenter:"HELPCENTER",email:"EMAIL",chat:"CHAT",forum:"FORUM",marketing:"MARKETING",onebox:"ONEBOX",testing:"TESTING"}[b]||"LINK"}},Nb=function(a){window.guidedhelp=window.guidedhelp||{};if(window.guidedhelp.loaded)var b=
...
p("hgb.loadFlow",function(a,b,c,d,e,f,g,k,n,A,ac,bc){K(Ob(a,{D:bc||"",Ia:n||!1,document:A||void 0,I:ac||void 0,O:c,locale:d,S:e||void 0,source:"CUSTOM",B:k||void 0}))},void 0);p("hgb.resumeCookiedFlow",Sb,void 0);p("hgb.startFlowFromUrl",Qb,void 0);var Ub=function(a){Tb();return ya(a)},Tb=r;var Vb=/^[\w+/_-]+[=]{0,2}$/;var Wb=function(a,b,c){a.timeOfStartCall=(new Date).getTime();var d=c||l,e=d.document;a:{var f=(d||l).document;if((f=f.querySelector&&f.querySelector("script[nonce]"))&&(f=f.nonce||f.getAttribute("nonce"))&&Vb.test(f))break a;f=void 0}f&&(a.nonce=f);if("help"==a.flow){var g=q("document.location.href",d);!a.helpCenterContext&&g&&(a.helpCenterContext=g.substring(0,1200));g=!0;if(b&&JSON&&JSON.stringify){var k=JSON.stringify(b);(g=1200>=k.length)&&(a.psdJson=k)}g||(b={invalidPsd:!0})}b=[a,b,c];d.GOOGLE_FEEDBACK_START_ARGUMENTS=
